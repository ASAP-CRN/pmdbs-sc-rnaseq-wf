...
hvgs_full = scanpy.experimental.pp.highly_variable_genes(
    adata,
    n_top_genes=n_top_genes_all,
    batch_key=batch_key,
...
# check that these hacks still work to make sure we keep the marker genes
...
scanpy.pp.pca(adata, n_comps=n_components)
